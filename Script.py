...
<blockquote>👇 නිවැරදි අක්ෂර වින්‍යාසය තෝරන්න</blockquote>"""
...
<blockquote>😌 මෙම උපසිරැසි මා සතු දත්ත ගබඩාවේ නැත.</blockquote>"""
...
<blockquote>ඔබගේ <b>ප්‍රිමියම් ප්‍රවේශය</b> ඉවත් කර ඇත.  
අපගේ සේවාව භාවිතා කිරීම ගැන ස්තුතියි 😊  
වෙනත් ගාස්තු පිරික්සීමට /plan මත click කරන්න.</blockquote>
"""
...
# ==============================================================================
# NEW REQUEST SYSTEM MESSAGES (DO NOT DELETE ANYTHING ABOVE)
# ==============================================================================

    REQUEST_START_TXT = """<b>🔍 ඔබට අවශ්‍ය චිත්‍රපටයේ හෝ වෙබ් කතාමාලාවේ නම ටයිප් කරන්න:

උදාහරණ:
• <code>Leo</code>
• <code>Jawan</code>
• <code>Loki S01</code>
• <code>Money Heist</code>

⏳ තත්පර 60ක් ඇතුළත පිළිතුරු දෙන්න.</b>"""

    REQUEST_TIMEOUT_TXT = """<b>⏰ කල් ඉකුත් විය! කරුණාකර නැවත /request භාවිතා කරන්න.</b>"""

    REQUEST_SEARCHING_TXT = """<b>🔎 ඔබගේ ඉල්ලීම '{query}' සඳහා TMDB හි සොයමින්...</b>"""

    REQUEST_NO_RESULTS_TXT = """<b>😕 සමාවන්න, '{query}' සඳහා ප්‍රතිඵල හමු නොවීය.

🔍 නිවැරදි අක්ෂර වින්‍යාසය පරීක්ෂා කර නැවත උත්සාහ කරන්න.</b>"""

    REQUEST_SELECT_MOVIE_TXT = """<b>🎬 පහතින් ඔබේ චිත්‍රපටය තෝරන්න:</b>"""

    REQUEST_DETAILS_TXT = """<b>🎬 {title} ({year})
...
⬇️ උපසිරැසි ලබා ගැනීමට පහත බොත්තම ඔබන්න:</b>"""

    REQUEST_AVAILABLE_TXT = """<b>✅ මෙම චිත්‍රපටය සඳහා උපසිරැසි අප සතුව ඇත!</b>"""
    
    REQUEST_NOT_AVAILABLE_TXT = """<b>❌ මෙම චිත්‍රපටය සඳහා උපසිරැසි තවමත් නැත.</b>"""

    REQUEST_BUTTON_TXT = "📥 උපසිරැසි ඉල්ලන්න"

    REQUEST_SUBMITTED_TXT = """<b>✅ ඔබගේ ඉල්ලීම ලැබී ඇත! කරුණාකර රැඳී සිටින්න.

ඉල්ලීම: {title} ({year})
යවන ලද්දේ: {user}</b>"""

    REQUEST_LOG_TXT = """#නව_ඉල්ලීම

🎬 චිත්‍රපටය: {title} ({year})
👤 පරිශීලක: {user} (ID: {user_id})
⏰ වේලාව: {time}"""
