...
async def add_redeem_code(client, message):
    ...
    if len(message.command) == 3:
        ...
        text = f"""
            <b>🎉 <u>Gɪᴠᴇᴀᴡᴀʏ Gᴇɴᴇʀᴀᴛᴇᴅ ✅</u></b>

            <b> <u>Tᴏᴛᴀʟ Cᴏᴅᴇs:</u></b> {num_codes}

            {codes_text}

            <b>⏳ <u>Duration:</u></b> {time}

            🌟<u>𝐘𝐨𝐮𝐫 𝐑𝐞𝐝𝐞𝐞𝐦 𝐂𝐨𝐝𝐞𝐬 𝐀𝐫𝐞 𝐇𝐞𝐫𝐞</u>🌟
        ...
        await message.reply_text("<b>♻ Usage:\n\n➡️ <code>/add_redeem 1min 1</code>,\n➡️ <code>/add_redeem 1hour 10</code>,\n➡️ <code>/add_redeem 1day 5</code></b>")
                ...
                if seconds > 0:
                    ...
                    if current_expiry and current_expiry > now_aware:
                        ...
                        await message.reply_text(
                            f"🚫 <b>Yᴏᴜ ᴀʟʀᴇᴀᴅʏ ʜᴀᴠᴇ ᴀɴ ᴀᴄᴛɪᴠᴇ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇss!</b>\n\n"
                            f"⏳ <b>Cᴜʀʀᴇɴᴛ Pʀᴇᴍɪᴜᴍ Exᴘɪʀʏ:</b> {expiry_str_in_ist}\n\n"
                            f"<i>Yᴏᴜ ᴄᴀɴɴᴏᴛ ʀᴇᴅᴇᴇᴍ ᴀɴᴏᴛʜᴇʀ ᴄᴏᴅᴇ ᴜɴᴛɪʟ ʏᴏᴜʀ ᴄᴜʀʀᴇɴᴛ ᴘʀᴇᴍɪᴜᴍ ᴇxᴘɪʀᴇs.</i>\n\n"
